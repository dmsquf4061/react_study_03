...
function CouponModal({ couponValue, valid, modalClose, handleClose, handleCoupon, handleOutsideClick }) {
    return (
        <div
            className={`${modalClose ? 'hidden' : 'fixed'} z-40 top-0 left-0 flex items-center justify-center w-full h-full bg-pink-100/15 p-6 md:p-12 overflow-hidden`}
